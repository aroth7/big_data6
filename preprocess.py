...
# dummies for country = zambia and country = thailand becauuse those 2 have the lowest avg days_until_funded
...
# dummies for sectors with avg days_until_funded < 1 (health, education, and arts) as well
